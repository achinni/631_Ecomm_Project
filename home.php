		...
		<li class="dropdown">
			...
			<div class="dropdown-menu" style="padding: 10px; padding-bottom: 0px;">
				<form method="post" action="#" accept-charset="UTF-8">
					<input style="margin:5px;" type="text" placeholder="Admin name" id="ausername" name="ausername">
					<input style="margin:5px; margin-bottom:10px;" type="password" placeholder="Password" id="apassword" name="apwd">
...
<div class='container-fluid'>
	...
	<div class="col-md-5">
		...
		<script type = "text/javascript">
		//tooltips for textbox
		 $('#remail').tooltip({'trigger':'focus', 'title': 'example@examplemail.com'});
		 $('#rusername').tooltip({'trigger':'focus', 'title': 'Minimum 6 Characters'});
		  </script>
		<!-- registration popup-->
